...
const areas: Record<string, Area> = {
  manchester: { name: "Manchester", region: "Manchester city centre and surrounding neighbourhoods", description: "Professional cleaning services in Manchester. We provide house, deep, and office cleaning across the city centre. Get a free quote today!", nearby: ["City Centre", "Ancoats", "Northern Quarter", "Deansgate", "Castlefield", "Fallowfield"] },
  salford: { name: "Salford", region: "Salford, Salford Quays, MediaCityUK and nearby postcodes", description: "Professional cleaning services in Salford. We provide house, deep, and office cleaning across Salford Quays and MediaCityUK. Get a free quote!", nearby: ["Salford Quays", "MediaCityUK", "Ordsall", "Eccles", "Swinton", "Worsley"] },
  stockport: { name: "Stockport", region: "Stockport and the surrounding residential communities", description: "Professional cleaning in Stockport. We provide house, deep, and office cleaning across the area. Get a free quote!", nearby: ["Edgeley", "Bramhall", "Cheadle", "Heaton Moor", "Marple", "Davenport"] },
  trafford: { name: "Trafford", region: "Trafford and the wider south-west Greater Manchester area", description: "Professional cleaning services in Trafford. We provide house, deep, end of tenancy, and office cleaning across the area. Get a free quote today.", nearby: ["Stretford", "Urmston", "Altrincham", "Sale", "Timperley", "Hale"] },
  didsbury: { name: "Didsbury", region: "West Didsbury, East Didsbury and nearby south Manchester areas", description: "Professional cleaning services in Didsbury. We provide house, deep, and office cleaning across West and East Didsbury. Get a free quote!", nearby: ["West Didsbury", "East Didsbury", "Withington", "Burnage", "Fallowfield", "Parrs Wood"] },
  chorlton: { name: "Chorlton", region: "Chorlton-cum-Hardy and neighbouring south Manchester postcodes", description: "Professional cleaning services in Chorlton. We provide house, deep, and office cleaning across Chorlton-cum-Hardy. Get a free quote today!", nearby: ["Chorlton-cum-Hardy", "Whalley Range", "Stretford", "Old Trafford", "Firswood", "Hulme"] },
  ...
  altrincham: { name: "Altrincham", region: "Altrincham, Timperley, Hale and surrounding areas", description: "Professional cleaning services in Altrincham. We provide house, deep, and office cleaning across Altrincham, Timperley, and Hale. Get a free quote!", nearby: ["Timperley", "Hale", "Bowdon", "Warrington", "Sale", "Knutsford"] },
  prestwich: { name: "Prestwich", region: "Prestwich, Whitefield and north Manchester communities", description: "Professional cleaning services in Prestwich. We provide house, deep, and office cleaning across Prestwich and Whitefield. Get a free quote!", nearby: ["Whitefield", "Heaton Park", "Crumpsall", "Broughton", "Bury", "Middleton"] },
  wilmslow: { name: "Wilmslow", region: "Wilmslow and nearby Cheshire and south Manchester locations", description: "Professional cleaning services in Wilmslow. We provide house, deep, and office cleaning across Wilmslow and Cheshire. Get a free quote today!", nearby: ["Handforth", "Styal", "Alderley Edge", "Macclesfield", "Cheadle", "Bramhall"] },
};
...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    description: `Professional cleaning services in ${area.name}. We provide expert house, deep, and commercial cleaning across the area. Get a free quote today!`,
